            ...
            <div class="row">
                ...
                <div class="col-lg-12 mb-4 mb-sm-5 border py-3 px-2">
                    <div>
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-2">
                            @if (isset(auth()->user()->jobSeeker->highest_education , auth()->user()->jobSeeker->date_graduated , auth()->user()->jobSeeker->field_of_study , auth()->user()->jobSeeker->school_name))
                                <button class="btn btn-primary mt-1 float-end" data-bs-toggle="modal"
                ...
                <div class="col-lg-12 mb-4 mb-sm-5">
                    <div>
                        ...
                        <div class="border p-2 d-flex align-items-center justify-content-start flex-wrap gap-1 py-4">
                            ...
                            @foreach (auth()->user()->jobSeeker->skill as $skill)
                                ...
                                <span class="bg-primary text-light fw-bold px-1 py-2 rounded">{{ $skill->name }}
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm text-light strong"><i class="fa-solid fa-x"></i></button>
                                </span>
                                </form>
                            @endforeach
                        ...
                        <button class="btn btn-primary mt-1 float-end" data-bs-toggle="modal"
                            data-bs-target="#skillModal" @disabled(auth()->user()->jobSeeker->skill->count() >= 5)>Add</button>
                ...
                <div class="col-lg-12 mb-4 mb-sm-5">
                    <div class="d-flex flex-column">
                        ...
                        @foreach ($auth_resumes as $auth_resume)
                            <a target="_blank" href="{{ auth()->user()->jobSeeker->getFirstMediaUrl('resumes') }}" class="rounded py-3 px-2 text-decoration-none bg-primary text-light d-flex align-items-center justify-content-start gap-1 px-3" style="">
                        ...
                        @else
                            <form action="{{ route('job_seeker.profile.resume.store', auth()->user()) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                    ...
                    <form action="{{ route('job_seeker.profile.education.store') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="field_of_study" class="form-control @error('field_of_study') is-invalid @enderror" value="{{ old('field_of_study') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="date" name="date_graduated" id="" class="form-control @error('date_graduated') is-invalid @enderror" value="{{ old('date_graduated') }}">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="school_name" class="form-control @error('school_name') is-invalid @enderror" value="{{ old('school_name') }}">
                                @error('school_name')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <div class="modal-body">
                    <form action="{{ route('job_seeker.profile.education.update',auth()->user()) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control @error('highest_education') is-invalid @enderror" name="highest_education" >
                                    ...
                                    <option @selected(auth()->user()->jobSeeker->highest_education == 'Secondary Education') value="Secondary Education">Secondary Education</option>
                                    <option @selected(auth()->user()->jobSeeker->highest_education == 'Primary Education') value="Primary Education">Primary Education</option>
                                    <option @selected(auth()->user()->jobSeeker->highest_education == 'Vocational Studies') value="Vocational Studies">Vocational Studies</option>
                                </select>
                                @error('highest_education')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-md-8">
                                <label>Field of Study</label>
                                <input type="text" name="field_of_study" class="form-control @error('field_of_study') is-invalid @enderror" value="{{ auth()->user()->jobSeeker->field_of_study ?? '' }}">
                                @error('field_of_study')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label>Date Graduated</label>
                                <input type="date" name="date_graduated" id="" class="form-control @error('date_graduated') is-invalid @enderror" value="{{ auth()->user()->jobSeeker->date_graduated ?? '' }}">
                                @error('date_graduated')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-md-8">
                                <label>School Name</label>
                                <input type="text" name="school_name" class="form-control @error('school_name') is-invalid @enderror" value="{{ auth()->user()->jobSeeker->school_name ?? '' }}">
                                @error('school_name')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
