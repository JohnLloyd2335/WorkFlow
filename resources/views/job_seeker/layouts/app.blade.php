                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('job_seeker.application.index') ? 'active' : '' }}"
                                    href="{{ route('job_seeker.application.index') }}">Job Application</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('bookmark.index') ? 'active' : '' }}"
                                    href="{{ route('bookmark.index') }}">Bookmark</a>
                            </li>
                        @endauth
                    </ul>
