...
@section('content')
    ...
    <div class="modal fade" id="editCompanyProfileModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="company_name"
                                    ...
                                    value="{{ auth()->user()->employer->company_name }}">
                                @error('company_name')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="services"
                                    ...
                                    value="{{ auth()->user()->employer->services }}">
                                @error('services')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea name="company_description" class="form-control @error('company_description') is-invalid @enderror"
                                    cols="8" rows="8" style="resize: none">{{ auth()->user()->employer->company_description }}</textarea>
