                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="{{ route('employer.jobs.edit',$job) }}">Edit Job</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <textarea name="description" class="form-control @error('description') is-invalid @enderror" style="resize:none"
                                            cols="10" rows="10">{{ $job->description }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="work_type"
                                            ...
                                            <option @selected($job->work_type == 'Onsite') value="Onsite">Onsite</option>
                                            <option @selected($job->work_type == 'Hybrid') value="Hybrid">Hybrid</option>
                                            <option @selected($job->work_type == 'Work from Home') value="Work from Home">Work from Home
                                            </option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="location"
                                            ...
                                            value="{{ $job->location }}" id="work_location">
