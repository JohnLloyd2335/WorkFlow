                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                  <a href="{{ route('admin.applications.show',$job->id) }}">Application</a>
                              </li>
                            </ol>
                        </nav>
                    </div>
   ...
   <script type="text/javascript">
    $(document).ready(function () {
        $('#applicantDataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.applications.show',$job->id) }}",
            columns: [
                {data: 'id', name: 'id'},
                {data: 'applicant_name', name: 'applicant_name'},
                {data: 'applicant_email', name: 'applicant_email'},
                {data: 'applicant_mobile_number', name: 'applicant_mobile_number'},
